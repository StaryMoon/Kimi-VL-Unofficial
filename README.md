...
[MoE Vision-Language Model / arXiv 2025]  
...
[Paper](https://arxiv.org/abs/2504.07491) · [PDF](https://arxiv.org/pdf/2504.07491) · [Issues](https://github.com/StaryMoon/Kimi-VL-Unofficial/issues) · [Release](https://github.com/StaryMoon/Kimi-VL-Unofficial/releases)
...
<p align="center">
  <img src="assets/paper-preview.png" alt="Kimi-VL-Unofficial paper or project page preview" width="900">
</p>

<sub>Image source: public paper PDF first-page screenshot, [Paper](https://arxiv.org/abs/2504.07491). Captured/organized on 2026-07-02. This repository is unofficial and is not affiliated with the paper authors.</sub>

## At a Glance

| Item | Details |
|---|---|
| Paper | Kimi-VL Technical Report |
| Venue / Source | MoE Vision-Language Model / arXiv 2025 |
| Focus | This repository organizes a PyTorch implementation for Kimi-VL Technical Report, focusing on efficient MoE vision-language modeling with long-context visual reasoning and agent... |
...
This repository organizes a PyTorch implementation for **Kimi-VL Technical Report**, focusing on efficient MoE vision-language modeling with long-context visual reasoning and agent capabilities. The codebase is structured like a standard research repository so that model components, configuration files, scripts, and evaluation utilities can be extended independently.
...
```bash
git clone https://github.com/StaryMoon/Kimi-VL-Unofficial.git
cd Kimi-VL-Unofficial
python -m venv .venv
...
```python
import torch
from kimi_vl_unofficial import ModelConfig, UnofficialModel, reconstruction_loss
...
```python
import torch
from kimi_vl_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables | [arXiv paper](https://arxiv.org/abs/2504.07491) |
| Ablation study | Experiment / ablation sections | [arXiv paper](https://arxiv.org/abs/2504.07491) |
| Qualitative examples | Main paper figures and appendix | [arXiv PDF](https://arxiv.org/pdf/2504.07491) |
...
- Thanks to the authors of **Kimi-VL Technical Report** for the original research.
...
pytorch, unofficial-implementation, reproduction, vlm, multimodal, moe, long-context, kimi-vl
